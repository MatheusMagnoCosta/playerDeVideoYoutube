...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(t)
        : (((e = "undefined" != typeof globalThis ? globalThis : e || self).Vimeo = e.Vimeo || {}), (e.Vimeo.Player = t()));
})(this, function () {
    "use strict";
    function r(e, t) {
    ...
    (o = "undefined" != typeof self ? self : "undefined" != typeof window ? window : l).WeakMap ||
        ...
        Player = (function () {
            function Player(u) {
                ...
                if (
                    ...
                    window.jQuery && u instanceof jQuery && (1 < u.length && window.console && console.warn && console.warn("A jQuery object with multiple elements was passed, using the first element."), (u = u[0])),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return new p(function (e) {
                                ...
                                A.delete(n),
                                    j.delete(n.element),
                                    n._originalElement && (j.delete(n._originalElement), n._originalElement.removeAttribute("data-vimeo-initialized")),
                                    n.element &&
                                        "IFRAME" === n.element.nodeName &&
                                        n.element.parentNode &&
                                        (n.element.parentNode.parentNode && n._originalElement && n._originalElement !== n.element.parentNode
                                            ? n.element.parentNode.parentNode.removeChild(n.element.parentNode)
                                    ...
                                    n.element &&
                                        ...
                                        (t = n.element.querySelector("iframe")) &&
                                            t.parentNode &&
                                            (t.parentNode.parentNode && n._originalElement && n._originalElement !== t.parentNode ? t.parentNode.parentNode.removeChild(t.parentNode) : t.parentNode.removeChild(t))),
    ...
    return (
        e ||
            ...
            (x = { fullscreenchange: F.fullscreenchange, fullscreenerror: F.fullscreenerror }),
            (C = {
                request: function (o) {
                    ...
                    return new Promise(function (t, e) {
                        ...
                        C.isFullscreen
                            ? ((n = function e() {
                              ...
                              C.on("fullscreenchange", n),
                              (r = document[F.exitFullscreen]()) instanceof Promise && r.then(n).catch(e))
                            : t();
                    });
                },
                on: function (e, t) {
